...
class SpawnAction(Action):
    ...
    # Strategy to be used for the new bot. Not sent to JSON.
    strategy: Optional[Any] = field(default=None, repr=False, compare=False)
    ...
    def to_json(self) -> Dict[str, Any]:
        data = {
            ...
            "location": {"x": self.spawn_location.x, "y": self.spawn_location.y},
        }
        return data
